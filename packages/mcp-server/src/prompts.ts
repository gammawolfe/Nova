      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '7a. If nova_check_registration returns the CLAIM_LOCKED error code, STOP polling and tell me verbatim: "Nova has locked grant pickup for this agent after repeated claim-secret mismatches. This usually means another process is racing the claim with a wrong secret. Investigate before reissuing — if my local identity is intact, ask the operator to run nova_reissue_ucan; if you suspect a leak, deregister this agentId and start over with a fresh invite." Do NOT retry polling — the lockout persists until reissue.',
