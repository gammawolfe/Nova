      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '6. Do the work. If the skill is long-running, send intermediate updates by calling nova_respond with status="working" and a partial result — do not wait silently past the visibility window.',
            '7. Call nova_respond with the final TaskResult (status="completed" or "failed") well before the 5-minute window elapses.',
